/*
 * @(#)ConferenceServiceBean.java	Jul 14, 2005
 *
...
public class ConferenceServiceBean implements ConferenceService {
	...
	// DAOs
	@EJB protected ConferenceDAO conferenceDAO;
	@EJB protected NewsDAO newsDAO;
	...
	public PresentationSummary getPresentation(int presentationId) {
		...
		return (PresentationSummary)presentationSummaryBuilder.build(presentation);
	}
